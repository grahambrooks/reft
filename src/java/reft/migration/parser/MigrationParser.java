...
public class MigrationParser extends Parser {
    ...
    public static class MigrationFileContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(MigrationParser.EOF, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MigrationVisitor)
                return ((MigrationVisitor<? extends T>) visitor).visitMigrationFile(this);
    ...
    public static class MigrationDeclarationContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_migrationDeclaration;
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MigrationVisitor)
                return ((MigrationVisitor<? extends T>) visitor).visitMigrationDeclaration(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class RenameMigrationContext extends ParserRuleContext {
        ...
        public TerminalNode Identifier() {
            return getToken(MigrationParser.Identifier, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MigrationVisitor)
                return ((MigrationVisitor<? extends T>) visitor).visitRenameMigration(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public final RenameMigrationContext renameMigration() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                match(1);
                setState(21);
                ((RenameMigrationContext) _localctx).predicate = qualifiedName();
                setState(22);
                match(3);
                setState(23);
                ((RenameMigrationContext) _localctx).newName = match(Identifier);
            }
        } catch (RecognitionException re) {
            _localctx.exception = re;
            _errHandler.reportError(this, re);
    ...
    public static class QualifiedNameContext extends ParserRuleContext {
        public List<TerminalNode> Identifier() {
            return getTokens(MigrationParser.Identifier);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof MigrationVisitor)
                return ((MigrationVisitor<? extends T>) visitor).visitQualifiedName(this);
            else return visitor.visitChildren(this);
        }
    }
